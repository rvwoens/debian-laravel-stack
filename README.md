...
[![GitHub Release](https://img.shields.io/badge/release-1.0.00-blue)](https://github.com/rvwoens/Debian-laravel-stack)
...
```bash
yum -y install tar
curl -s -L https://github.com/rvwoens/Debian-laravel-stack/archive/v1.0.00.tar.gz | tar -xz
