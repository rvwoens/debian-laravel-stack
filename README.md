...
[![GitHub Release](https://img.shields.io/badge/release-2.0.06-blue)](https://github.com/rvwoens/Debian-laravel-stack)
...
```bash
curl -s -L https://github.com/rvwoens/debian-laravel-stack/archive/v2.0.06.tar.gz | tar -xz
cd debian-laravel-stack-2.0.06
./setup_full
```
