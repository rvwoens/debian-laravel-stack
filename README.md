...
[![GitHub Release](https://img.shields.io/badge/release-1.0.19-blue)](https://github.com/rvwoens/Debian-laravel-stack)
...
```bash
curl -s -L https://github.com/rvwoens/debian-laravel-stack/archive/v1.0.19.tar.gz | tar -xz
cd debian-laravel-stack-1.0.19
./setup_full
```
